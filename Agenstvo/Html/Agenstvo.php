    ...
    <div class="container">
      <div class="main" >
           ...
           <div class="container">
            ...
            туристического агентства </br>
            "Неваляшка"!</br>
            Готовы помочь вам </br>
            с выбором лучшего отдыха — </br>
            незабываемых путешествий, </br>
            ярких приключений </br>
            и неповторимых впечатлений!</br>
            </div>    
        <img class="imgs" src="\Agenstvo\img\Agenstvo\1.jpg">
        <img class="imgs" src="\Agenstvo\img\Agenstvo\2.jpg">
        <img class="imgs" src="\Agenstvo\img\Agenstvo\3.jpg">  
           </div>

  
  
        <div class="btn-hover">
          <button onclick ="location.href = ''"   class="btn-hover color">Просмотреть</button>
        </div> 
      </div> 
    </div>
</main>  
